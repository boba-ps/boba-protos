...
class Weapon$Type extends MessageType {
    constructor() {
        super("Weapon", [
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.affixMap))
            writer.tag(4, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.affixMap[k]).join();
