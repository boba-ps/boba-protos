...
class MPLevelEntityInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("MPLevelEntityInfo", [
            ...
            { no: 3, name: "ability_info", kind: "message", T: () => AbilitySyncStateInfo_1.AbilitySyncStateInfo }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 authority_peer_id */ 2:
                    ...
                    break;
                case /* AbilitySyncStateInfo ability_info */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.abilityInfo)
            AbilitySyncStateInfo_1.AbilitySyncStateInfo.internalBinaryWrite(message.abilityInfo, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options).join();
