...
class QueryCurrRegionHttpRsp$Type extends MessageType {
    constructor() {
            ...
            switch (fieldNo) {
                case /* ForceUpdateInfo force_udpate */ 4:
                    message.detail = {
                        ...
                        forceUdpate: ForceUpdateInfo.internalBinaryRead(reader, reader.uint32(), options, message.detail.forceUdpate)
                    };
                    break;
                case /* StopServerInfo stop_server */ 5:
                    message.detail = {
                        oneofKind: "stopServer",
                        stopServer: StopServerInfo.internalBinaryRead(reader, reader.uint32(), options, message.detail.stopServer)
                    };
                    break;
