...
class AvatarInfo$Type extends MessageType {
    constructor() {
        super("AvatarInfo", [
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.propMap)) {
            ...
            PropValue.internalBinaryWrite(message.propMap[k], writer, options);
            writer.join().join();
        }
        /* uint32 life_state = 4; */
        ...
        for (let k of Object.keys(message.fightPropMap))
            writer.tag(7, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Bit32).float(message.fightPropMap[k]).join();
        ...
        for (let k of Object.keys(message.skillMap)) {
            ...
            writer.tag(2, WireType.LengthDelimited).fork();
            AvatarSkillInfo.internalBinaryWrite(message.skillMap[k], writer, options);
            writer.join().join();
        }
        ...
        for (let k of Object.keys(message.skillLevelMap))
            writer.tag(15, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.skillLevelMap[k]).join();
        ...
        for (let k of Object.keys(message.proudSkillExtraLevelMap))
            writer.tag(17, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.proudSkillExtraLevelMap[k]).join();
        /* bool is_focus = 18; */
