// @generated by protobuf-ts 2.4.0 with parameter generate_dependencies,output_typescript,// @generated from protobuf file "MPLevelEntityInfo.proto" (syntax proto3),// tslint:disable
...
class MPLevelEntityInfo$Type extends MessageType<MPLevelEntityInfo> {
    constructor() {
        super("MPLevelEntityInfo", [
            ...
            { no: 3, name: "ability_info", kind: "message", T: () => AbilitySyncStateInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: MPLevelEntityInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.abilityInfo)
            AbilitySyncStateInfo.internalBinaryWrite(message.abilityInfo, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
