        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* Material material */ 5:
                    message.detail = {
                        oneofKind: "material",
                        material: Material.internalBinaryRead(reader, reader.uint32(), options, message.detail.material)
                    };
                    break;
                case /* Equip equip */ 6:
                    message.detail = {
                        oneofKind: "equip",
                        equip: Equip.internalBinaryRead(reader, reader.uint32(), options, message.detail.equip)
                    };
                    break;
                case /* Furniture furniture */ 7:
                    message.detail = {
                        oneofKind: "furniture",
                        furniture: Furniture.internalBinaryRead(reader, reader.uint32(), options, message.detail.furniture)
                    };
                    break;
