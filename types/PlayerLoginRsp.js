 ...
 */
export var PlayerLoginRsp_CmdId;
...
})(PlayerLoginRsp_CmdId || (PlayerLoginRsp_CmdId = {}));
// @generated message type with reflection information, may provide speed optimized methods
class PlayerLoginRsp$Type extends MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.blockInfoMap)) {
            ...
            BlockInfo.internalBinaryWrite(message.blockInfoMap[k], writer, options);
            writer.join().join();
        }
