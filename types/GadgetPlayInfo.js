...
class GadgetPlayInfo$Type extends MessageType {
    constructor() {
            ...
            switch (fieldNo) {
                case /* GadgetCrucibleInfo crucible_info */ 21:
                    message.playInfo = {
                        ...
                        crucibleInfo: GadgetCrucibleInfo.internalBinaryRead(reader, reader.uint32(), options, message.playInfo.crucibleInfo)
                    };
                    break;
