...
class SceneMonsterInfo$Type extends MessageType {
    constructor() {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* SceneFishInfo fish_info */ 50:
                    message.content = {
                        oneofKind: "fishInfo",
                        fishInfo: SceneFishInfo.internalBinaryRead(reader, reader.uint32(), options, message.content.fishInfo)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.summonTagMap))
            writer.tag(10, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.summonTagMap[k]).join();
        /* uint32 pose_id = 11; */
        if (message.poseId !== 0)
