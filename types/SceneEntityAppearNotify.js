...
exports.SceneEntityAppearNotify = exports.SceneEntityAppearNotify_CmdId = void 0;
...
class SceneEntityAppearNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneEntityAppearNotify", [
            { no: 1, name: "entity_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SceneEntityInfo_1.SceneEntityInfo },
            { no: 2, name: "appear_type", kind: "enum", T: () => ["VisionType", VisionType_1.VisionType] },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.entityList.length; i++)
            SceneEntityInfo_1.SceneEntityInfo.internalBinaryWrite(message.entityList[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* VisionType appear_type = 2; */
        if (message.appearType !== 0)
            writer.tag(2, runtime_1.WireType.Varint).int32(message.appearType);
        /* uint32 param = 3; */
        if (message.param !== 0)
