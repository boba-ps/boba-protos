// @generated by protobuf-ts 2.4.0 with parameter generate_dependencies,output_typescript,// @generated from protobuf file "AbilityScalarValueEntry.proto" (syntax proto3),// tslint:disable
...
class AbilityScalarValueEntry$Type extends MessageType<AbilityScalarValueEntry> {
    constructor() {
        super("AbilityScalarValueEntry", [
            ...
            { no: 2, name: "value_type", kind: "enum", T: () => ["AbilityScalarType", AbilityScalarType] }
        ]);
    }
